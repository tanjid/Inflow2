...
TEMP_DIR = os.path.join(BASE_DIR, '_templates',)
ADDITIONAL_TEMPLATE = os.path.join(BASE_DIR, 'templates',)
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'theme': 'djangoproject.templatetags.theme',
            },
            'builtins': [
                'django.templatetags.static',
                'djangoproject.templatetags.theme',
            ]
        },
    },
]
